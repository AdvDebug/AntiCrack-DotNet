...
namespace AntiCrack_DotNet
{
    class Program
    {
        private static void ExecuteAntiDebuggingTricks()
        {
            ...
            Console.WriteLine("NtQueryInformationProcess ProcessDebugFlags: " + AntiDebug.NtQueryInformationProcessCheck_ProcessDebugFlags() + "\n");
            Console.WriteLine("NtQueryInformationProcess ProcessDebugPort: " + AntiDebug.NtQueryInformationProcessCheck_ProcessDebugPort() + "\n");
            Console.WriteLine("NtQueryInformationProcess ProcessDebugObjectHandle: " + AntiDebug.NtQueryInformationProcessCheck_ProcessDebugObjectHandle() + "\n");
            Console.WriteLine("CloseHandle Anti Debug: " + AntiDebug.CloseHandleAntiDebug() + "\n");
            Console.WriteLine("Hardware Registers Breakpoints Detection: " + AntiDebug.HardwareRegistersBreakpointsDetection() + "\n");
            Console.WriteLine("Looking For Bad Debuggers Windows (FindWindow): " + AntiDebug.FindWindowAntiDebug() + "\n");
            Console.WriteLine("GetTickCount Anti Debug: " + "Skipped" + "\n"); //it's unreliable for real anti-debug use
            //AntiDebug.GetTickCountAntiDebug();
            Console.WriteLine("OutputDebugString Anti Debug: " + "Skipped" + "\n"); //it's unreliable for real anti-debug use
            //AntiDebug.OutputDebugStringAntiDebug();
        ...
        private static void ExecuteAntiDllInjectionTricks()
        {
            ...
            Console.WriteLine("Taking Advantage of Binary Signature Mitigation Policy to Prevent Non-Microsoft Binaries From Being Injected..... " + AntiDllInjection.BinarySignatureMitigationAntiDllInjection() + "\n");
            Console.WriteLine("------------------------------------------------------------------------------------------------------------------------\n\n");
        }
